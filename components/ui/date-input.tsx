...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
    ...
    return (
        <div className="flex border bg-inherit rounded-lg items-center text-sm px-1">
            <input
                type="text"
                ref={dayRef}
                max={31}
                ...
                className="p-0 outline-none bg-inherit w-7 border-none text-center"
                placeholder="D"
            />
            ...
            <input
                ...
                className="p-0 outline-none bg-inherit w-6 border-none text-center"
                placeholder="M"
            />
            ...
            <input
                ...
                className="p-0 outline-none bg-inherit w-12 border-none text-center"
                placeholder="YYYY"
            />
        </div>
    )
